...
export default function HerbLocationEditModal({open, location, districts, onClose, onUpdate,}: {
    open: boolean;
    ...
    const handleGetLatAndLng = () => {
        ...
        fetch("/api/tencent-geocoder?address="+address)
            ...
            .then(data => {
                ...
                console.log("lng", data.data.result.location.lng)
                console.log("lat", data.data.result.location.lat)
            })
