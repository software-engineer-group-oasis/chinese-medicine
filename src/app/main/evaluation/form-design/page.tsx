...
import { 
  Card, Form, Input, Button, Space, Select, InputNumber, Switch, 
  Table, Popconfirm, message, Divider, Typography, Breadcrumb, Tabs
} from 'antd';
import { 
...
export default function FormDesignPage() {
  ...
  const handleDelete = (key) => {
    const newData = dimensions.filter((item) => item.key !== key);
    setDimensions(newData);
