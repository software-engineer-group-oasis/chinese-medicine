...
import { 
  Card, Form, Input, Button, Select, Rate, Upload, DatePicker, 
  Divider, Typography, Breadcrumb, Steps, message, Space, Radio,
  InputNumber, Row, Col, Collapse
} from 'antd';
import { 
